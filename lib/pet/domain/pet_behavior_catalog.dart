...
class PetBehaviorCatalog {
  ...
  static const actionDefinitions = <PetBehaviorAction, PetActionDefinition>{
    ...
    PetBehaviorAction.runChase: PetActionDefinition(
      ...
      supportedStimulusTypes: [PetStimulusType.userTap],
      supportedContentKinds: [PetNormalizedContentKind.emoji],
      supportedTargetKinds: [WorldObjectKind.emojiToy],
  ...
  static const legacyTapTriggers = <PetBehaviorTrigger>[
    PetBehaviorTrigger(
